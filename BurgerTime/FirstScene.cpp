...
void FirstScene::LoadSceneElements()
{
    ...
    auto scoreComponent = std::make_shared<PointComponent>(scoreGO, 0, glm::vec3{ 170.f, 30.f, 0.0f }, "../Data/HighScores.txt");
    ...
    auto pepperComponent = std::make_shared<PointComponent>(pepperGO, 0, glm::vec3{ 600.f, 30.f, 0.0f }, "../Data/HighScores.txt");
